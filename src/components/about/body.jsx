        ...
        <div className='bg-gradient-to-t from-[#0073AF] to-[#003049] pl-[84px] pt-[100px] pb-[50px]'>
            ...
            <div className='flex  flex flex-col lg:flex-row'>
                <div className='flex flex-col gap-[34px]' style={{ flex: '1' }}>
                    ...
                    <p className='jaldi text-[32px]  text-[#FFFFFF]'>Filing your Self-Assessment tax return shouldn’t be complicated, time-consuming, or stressful. That’s why we created TaxReady.uk—a fast, easy, and accurate way to submit your taxes directly to HMRC with confidence.</p>
                    <p className='jaldi text-[32px]  text-[#FFFFFF]'>We believe that tax filing should be simple and accessible for everyone. Our goal is to remove the guesswork and frustration from the Self-Assessment process, ensuring that individuals, freelancers, and small business owners can file their taxes quickly and accurately without hassle.</p>
                    <div className='flex flex-col gap-[10px]'>
                        <p className='font-semibold text-[32px] text-[#FFFFFF]'>Why Choose Us?</p>
                        <ul className="list-disc pl-5">
                            <li className="jaldi text-[32px] text-[#FFFFFF]">
                    ...
                    <div className='flex flex-col gap-[10px]'>
                        <p className='font-semibold text-[32px] text-[#FFFFFF]'>How It Works</p>
                    ...
                    <p className='jaldi text-[32px]  text-[#FFFFFF]'>We are dedicated to making tax filing as stress-free as possible. With expert-backed accuracy, real-time error checking, and an intuitive user experience, we make filing your taxes simple and stress free.</p>
                </div>
