...
const Body = () => {
    ...
    return (
        <div>
            ...
            <div className='mt-[66px] ml-[130px] flex flex-col md:flex-row gap-[50px]'>
                <div className='bg-gradient-to-t from-[#0073AF] to-[#003049] py-[47px] px-[56px] flex-1 rounded-[10px] flex flex-col gap-[22px]'>
                    <h1 className='font-bold text-[60px]' style={{ color: "rgba(255, 255, 255, 1)" }}>Simple Pricing</h1>
                    <h1 className='archivo text-[43px] font-semibold' style={{ color: "rgba(255, 255, 255, 1)" }}>£ 12.00 / per filing</h1>
                    ...
                    <div className='mt-[59px] flex flex-col gap-[32px]'>
                        <div className='flex items-center gap-[21px]'>
                            ...
                            <p className='archivo text-[28px] ' style={{ color: 'rgba(255, 255, 255, 1)' }}>Unlimited business types</p>
                        </div>
                        <div className='flex items-center gap-[21px]'>
                            <div className='h-[36px] w-[36px] bg-black flex justify-center items-center' style={{ borderRadius: "50%" }}>
                                <img src={check} />
                            </div>
                            <p className='archivo text-[28px] ' style={{ color: 'rgba(255, 255, 255, 1)' }}>Unlimited expense types</p>
                        </div>
                        <div className='flex items-center gap-[21px]'>
                            <div className='h-[36px] w-[36px] bg-black flex justify-center items-center' style={{ borderRadius: "50%" }}>
                                <img src={check} />
                            </div>
                            <p className='archivo text-[28px] ' style={{ color: 'rgba(255, 255, 255, 1)' }}>Secure payment through Stripe</p>
                        </div>
                        <div className='flex items-start gap-[21px]'>
                            <div className='h-[36px] w-[36px] bg-black flex justify-center items-center' style={{ borderRadius: "50%" }}>
                                <img src={check} />
                            </div>
                            <p className='archivo text-[28px] ' style={{ color: 'rgba(255, 255, 255, 1)' }}>Submit directly to HMRC and receive instant confirmation.</p>
                        </div>
                    </div>
                </div>
